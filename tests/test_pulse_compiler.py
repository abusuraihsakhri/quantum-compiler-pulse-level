...
import pytest
from pulse_compiler.models import FrontierPayload, ExecutionStatus
from pulse_compiler.engine import FrontierDomainEngine
from pulse_compiler.agents import DRAGPulseShaperAgent, RabiOscillationAnalyzerAgent, StateLeakageAuditorAgent, PulseControlCoordinator
from pulse_compiler.cli import main


def test_sub_agents():
    a1 = DRAGPulseShaperAgent()
    ...
    a2 = RabiOscillationAnalyzerAgent()
...
def test_coordinator():
    ...
    assert "Qiskit Pulse / OpenPulse Standard" in ans or "specifications" in ans
